...
extern const int localMapLength = 80; // length of the local occupancy grid map (meter)
extern const int localMapArrayLength = localMapLength / mapResolution;
extern const int localMapWidth = 54; // length of the local occupancy grid map (meter)
extern const int localMapArrayWidth= localMapWidth / mapResolution;
